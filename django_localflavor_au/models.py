...
class FormattedNumberField(CharField):
    ...
    errors = {
        'not_string': _(u'The provided value is not a string, it is a {0!r}'),
    }
...
class AUPhoneNumberField(FormattedNumberField):
    ...
    errors = {
        'not_string': _(u'The provided value is not a string, it is a {0!r}'),
        'missing_area_code': _(u'Phone numbers must have an area code'),
    }
...
class ABNField(FormattedNumberField):
    ...
    description = _(u'Australian Business Number field')
...
class ACNField(FormattedNumberField):
    ...
    description = _(u'Australian Company Number field')
